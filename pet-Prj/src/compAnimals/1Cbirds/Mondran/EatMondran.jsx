const eatcanare = [
  {
    ...
    Peat: ` Baby Calobsat birds eat nesting food which may differ from seeds to
    ...
    images: {
      ...
      ima2: "/public/eat-mondran1.jpg",
      ima3: "/public/eat-mondran3.jpg",
      ima4: "/public/eat-mondran2.jpg",
      ima5: "/public/eat-calo3.png",
    },

    bybyImage: "/public/byby-mondran.jpg",
  },
  {
    id: 2,
    title: "When It Is A Grow",
    Peat: `    Captive calobsat diets often try to mimic what they’d eat in the
        ...
        diet.`,
    images: {
      ima1: "/public/eat-mondran1.jpg",
      ima2: "/public/eat-can2.jpg",
      ima3: "/public/eat-can8.jpg",
      ima4: "/public/eat-mondran2.jpg",
      ima5: "/public/eat-mondran3.jpg",
    },

    bybyImage: "/public/Mond-bird5.jpg",
  },
];

export default function EatMondran() {
  return (
    <>
      {eatcanare.map((eatcn) => (
        <div key={eatcn.id}>
